...
! function (a, b) {
    ...
    S.v = function ta(a, b, c) {
        ...
        if (c.dom.style["touch-action"] = "none", c.dom.style["ms-touch-action"] = "none", ma(c), c.dom.id = "geetest_" + c.id, c.config.mobile ? c.dom.className = "gt_mobile_holder " + c.config.product : c.dom.className = "gt_holder " + c.config.product, "float" != c.config.product || c.config.mobile || ha(c), "popup" != c.config.product || c.config.mobile) b ? S.Z(a, c.dom) : a.appendChild(c.dom);
        else {
