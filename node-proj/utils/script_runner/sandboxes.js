...
const gs_jx = function () {
    ...
    function toEntname(url, pripid, searchtype = 'qyxy') {
        var pripids = pripid;
        var base = new Base64();
        pripids = base.encode(pripid);
        return "/" + url + "?pripid=" + pripids + "&searchtype=" + searchtype;
    }
